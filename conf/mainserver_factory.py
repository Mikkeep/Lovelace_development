...
ALLOWED_HOSTS = ["127.0.0.1", "192.168.1.50", "192.168.1.51"]
...
REDIS_RESULT_CONFIG = {"host": "192.168.1.51", "port": 6379, "db": 0}
REDIS_RESULT_EXPIRE = 60
REDIS_LONG_EXPIRE = 60 * 60 * 24 * 7

CELERY_RESULT_CONFIG = {"host": "192.168.1.51", "port": 6379, "db": 0}
#CELERY_BROKER_URL = 'amqp://guest:guest@192.168.1.51:5672//'
CELERY_BROKER_URL = 'amqp://lovelace:lovelace@192.168.1.51:5672//'
...
#RIVATE_STORAGE_FS_PATH = "/mnt/nfs"
PRIVATE_STORAGE_FS_PATH = "/var/lovelace/webapp/upload"
